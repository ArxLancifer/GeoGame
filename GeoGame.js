...
/* PAGE LOAD ZOOM IN (FOR FUN) */
// window.onload = function () {
//   let scaleCounter = 0;
//   const scaleInterval = setInterval(() => {
//     document.body.style.transform = `scale(${scaleCounter}%)`;
//     scaleCounter += 3;
...
function createNeightbours() {
  ...
  if (bordersArray == undefined) {
    ...
    for (let i = 0; i < bordersArray.length; i++) {
      ...
      //   console.log(bordersArray[i]);
    }
  }

  boardArray = [...bordersArray, ...notNeightboursArray];
  shuffleArray(boardArray);
  //   console.log(bordersArray, notNeightboursArray);
      ...
      (EVENT) => {
        ...
        if (
          ...
          if (validFlags == bordersArray.length) {
            ...
            // console.log(validFlags, bordersArray);
          }
        } else {
        ...
        // EVENT.currentTarget.style.border = Object.values(
